...
// Добавить его в главное меню
        ...
        Action showAboutProgramInfo = new AbstractAction("О программе") {
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(MainFrame.this, "Дыбаль Илья Денисович, 7 группа");
            }
        };
        aboutProgramItem = infoMenu.add(showAboutProgramInfo);
